(function () {
  ...
  function initData() {
    allResources = [
      ...
      { id: 201, code: 'LOT_MGMT', name: 'Quản lý lô hàng', description: 'Theo dõi và quản lý các lô hàng trong kho.' },
      { id: 202, code: 'INBOUND_ORDER', name: 'Lệnh nhập kho', description: 'Thực hiện các lệnh nhập hàng thực tế.' },
      { id: 203, code: 'OUTBOUND_ORDER', name: 'Lệnh xuất kho', description: 'Thực hiện các lệnh xuất hàng thực tế.' },
      { id: 204, code: 'ORDER_KANBAN', name: 'Kanban lệnh', description: 'Danh sách các lệnh nhập xuất theo Kanban' },
      ...
      { id: 401, code: 'DEVICE_LIST', name: 'Quản lý thiết bị', description: 'Quản lý danh mục thiết bị cụ thể.' },
      { id: 402, code: 'DEVICE_MAINTENANCE', name: 'Quản lý bảo trì', description: 'Lập lịch và thực hiện bảo trì định kỳ.' },
      { id: 403, code: 'DEVICE_ORCHESTRATOR', name: 'Điều phối thủ công', description: 'Giao diện điều phối thiết bị thủ công.' },
      { id: 501, code: 'WORKFLOW_PROCESS', name: 'Danh sách Quy trình', description: 'Cấu hình các bước trong quy trình nghiệp vụ.' },
      { id: 601, code: 'INVENTORY_MGMT', name: 'Theo dõi tồn kho', description: 'Kiểm kê và theo dõi số lượng tồn kho.' },
      { id: 602, code: 'STATISTIC_REPORT', name: 'Báo cáo Nhập/Xuất', description: 'Báo cáo tổng hợp dữ liệu nhập và xuất.' },
      { id: 701, code: 'DEVICE_TYPE', name: 'Nhóm thiết bị', description: 'Phân loại các loại thiết bị.' },
      { id: 702, code: 'PRODUCT_LINE', name: 'Dòng sản phẩm', description: 'Quản lý danh mục dòng sản phẩm.' },
      { id: 703, code: 'PRODUCT_GROUP', name: 'Nhóm sản phẩm', description: 'Phân loại các nhóm sản phẩm.' },
      { id: 704, code: 'PRODUCT_LIST', name: 'Sản phẩm', description: 'Quản lý danh mục mã sản phẩm.' },
      { id: 705, code: 'METHOD', name: 'Quy cách', description: 'Quản lý danh mục quy cách đóng gói.' },
      { id: 706, code: 'CONTAINER_GROUP', name: 'Nhóm vật chứa', description: 'Phân loại các nhóm vật chứa.' },
      { id: 707, code: 'CONTAINER_LIST', name: 'Vật chứa', description: 'Quản lý danh mục vật chứa chi tiết.' },
      { id: 708, code: 'UNIT_OF_MEASURE', name: 'Đơn vị tính', description: 'Quản lý danh mục các đơn vị đo lường.' },
      { id: 709, code: 'MARKET', name: 'Thị trường', description: 'Quản lý danh mục các thị trường.' },
      { id: 801, code: 'ACCOUNT', name: 'Tài khoản', description: 'Quản lý danh sách người dùng hệ thống.' },
      { id: 802, code: 'ROLE', name: 'Vai trò', description: 'Quản lý các nhóm quyền (Role).' },
      { id: 803, code: 'MENU', name: 'Chức năng', description: 'Quản lý cây menu và chức năng hệ thống.' },
      { id: 804, code: 'RESOURCE', name: 'Tài nguyên', description: 'Quản lý các tài nguyên (Resources) bảo mật.' }
    ];
