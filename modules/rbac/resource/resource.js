(function () {
  ...
  function initData() {
    allResources = [
      { id: 1, code: 'DASHBOARD_TONGQUAN', name: 'Dashboard Tổng quan', description: 'Trang dashboard hiển thị số liệu tổng quan của kho.' },
      { id: 2, code: 'DASHBOARD_CHITIET', name: 'Dashboard Chi tiết', description: 'Trang dashboard chi tiết từng khu vực.' },
      { id: 3, code: 'QUANLY_KHO', name: 'Quản lý Kho', description: 'Quản lý danh sách các kho trong hệ thống.' },
      { id: 4, code: 'QUANLY_VATCHUA', name: 'Quản lý vật chứa', description: 'Quản lý các loại vật chứa dùng trong kho.' },
      { id: 5, code: 'QUANLY_THIETBI', name: 'Quản lý thiết bị', description: 'Quản lý danh sách thiết bị chi tiết.' },
      { id: 6, code: 'LICH_BAOTRI_THIETBI', name: 'Lịch bảo trì thiết bị', description: 'Lập lịch và theo dõi bảo trì thiết bị.' },
      { id: 7, code: 'KANBAN_WCS', name: 'Kanban WCS', description: 'Giao diện kanban điều phối thiết bị.' },
      { id: 8, code: 'QUANLY_LENH', name: 'Quản lý Lệnh', description: 'Theo dõi và quản lý các lệnh điều phối.' },
      { id: 9, code: 'GIAMSAT_THIETBI', name: 'Giám sát Thiết bị', description: 'Giám sát trạng thái hoạt động thời gian thực.' },
      { id: 10, code: 'LENH_NHAPKHO', name: 'Lệnh nhập kho', description: 'Quản lý các yêu cầu nhập kho.' },
      { id: 11, code: 'LENH_XUATKHO', name: 'Lệnh xuất kho', description: 'Quản lý các yêu cầu xuất kho.' },
      { id: 12, code: 'QUANLY_QUYTRINH', name: 'Quản lý quy trình', description: 'Thiết lập các quy trình nghiệp vụ.' },
      { id: 13, code: 'NHOM_THIETBI', name: 'Nhóm thiết bị', description: 'Phân loại các loại nhóm thiết bị.' },
      { id: 14, code: 'THIETBI', name: 'Thiết bị', description: 'Danh sách chi tiết thiết bị.' },
      { id: 15, code: 'NHOM_SANPHAM', name: 'Nhóm sản phẩm', description: 'Phân loại các loại nhóm sản phẩm.' },
      { id: 16, code: 'SANPHAM', name: 'Sản phẩm', description: 'Danh sách chi tiết sản phẩm.' },
      { id: 17, code: 'VATCHUA', name: 'Vật chứa', description: 'Quản lý danh mục vật chứa.' },
      { id: 18, code: 'DON_VI_TINH', name: 'Đơn vị tính', description: 'Quản lý đơn vị tính vật tư.' },
      { id: 19, code: 'LOAI_VI_TRI', name: 'Loại vị trí', description: 'Quản lý các loại vị trí định danh.' },
      { id: 20, code: 'TAI_KHOAN', name: 'Tài khoản', description: 'Quản lý người dùng hệ thống.' },
      { id: 21, code: 'VAI_TRO', name: 'Vai trò', description: 'Quản lý phân quyền theo vai trò.' },
      { id: 22, code: 'CHUC_NANG', name: 'Chức năng', description: 'Quản lý danh mục chức năng menu.' },
      { id: 23, code: 'TAI_NGUYEN', name: 'Tài nguyên', description: 'Quản lý danh mục tài nguyên hệ thống.' }
    ];
