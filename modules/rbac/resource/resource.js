(function () {
  ...
  function initData() {
    allResources = [
      ...
      { id: 201, code: 'OUTBOUND_ORDER_ERP', name: 'Đơn hàng ERP', description: 'Đơn hàng ERP' },
      { id: 301, code: 'LOT_MGMT', name: 'Quản lý lô hàng', description: 'Theo dõi và quản lý các lô hàng trong kho.' },
      { id: 302, code: 'INBOUND_ORDER', name: 'Lệnh nhập kho', description: 'Thực hiện các lệnh nhập hàng thực tế.' },
      { id: 303, code: 'OUTBOUND_ORDER', name: 'Lệnh xuất kho', description: 'Thực hiện các lệnh xuất hàng thực tế.' },
      { id: 304, code: 'ORDER_KANBAN', name: 'Kanban lệnh', description: 'Danh sách các lệnh nhập xuất theo Kanban' },
      { id: 401, code: 'WAREHOUSE_LIST', name: 'Quản lý kho', description: 'Quản lý danh sách và cấu hình các kho.' },
      { id: 402, code: 'LOCATION_TYPE', name: 'Loại khu vực', description: 'Quản lý các loại khu vực lưu trữ.' },
      { id: 501, code: 'DEVICE_LIST', name: 'Quản lý thiết bị', description: 'Quản lý danh mục thiết bị cụ thể.' },
      { id: 502, code: 'DEVICE_MAINTENANCE', name: 'Quản lý bảo trì', description: 'Lập lịch và thực hiện bảo trì định kỳ.' },
      { id: 601, code: 'WORKFLOW_PROCESS', name: 'Danh sách Quy trình', description: 'Cấu hình các bước trong quy trình nghiệp vụ.' },
      { id: 701, code: 'INVENTORY_MGMT', name: 'Theo dõi tồn kho', description: 'Kiểm kê và theo dõi số lượng tồn kho.' },
      { id: 702, code: 'STATISTIC_REPORT', name: 'Báo cáo Nhập/Xuất', description: 'Báo cáo tổng hợp dữ liệu nhập và xuất.' },
      ...
      { id: 805, code: 'METHOD', name: 'Quy cách', description: 'Quản lý danh mục quy cách đóng gói.' },
      { id: 806, code: 'CONTAINER_GROUP', name: 'Nhóm vật chứa', description: 'Phân loại các nhóm vật chứa.' },
      { id: 807, code: 'CONTAINER_LIST', name: 'Vật chứa', description: 'Quản lý danh mục vật chứa chi tiết.' },
      { id: 808, code: 'UNIT_OF_MEASURE', name: 'Đơn vị tính', description: 'Quản lý danh mục các đơn vị đo lường.' },
      { id: 809, code: 'MARKET', name: 'Thị trường', description: 'Quản lý danh mục các thị trường.' },
      { id: 901, code: 'ACCOUNT', name: 'Tài khoản', description: 'Quản lý danh sách người dùng hệ thống.' },
      { id: 902, code: 'ROLE', name: 'Vai trò', description: 'Quản lý các nhóm quyền (Role).' },
      { id: 903, code: 'MENU', name: 'Chức năng', description: 'Quản lý cây menu và chức năng hệ thống.' },
      { id: 904, code: 'RESOURCE', name: 'Tài nguyên', description: 'Quản lý các tài nguyên (Resources) bảo mật.' }
    ];
