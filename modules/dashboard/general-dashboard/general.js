...
var DATA = {
  ...
  occ: [
    { name:'KHO CHUỐI NHẬT BẢN 01 — KNB-01', pct:96, cls:'hi',  cranes:'12/12', amr:'24/24', tag:'tag-hi',  note:'⚠ Gần giới hạn' },
    { name:'KHO CHUỐI QUỐC TẾ - KHU A — KCQ-A', pct:71, cls:'mid', cranes:'8/10',  amr:'18/20', tag:'tag-mid', note:'2 thiết bị bảo trì' },
    { name:'KHO CHUỐI QUỐC TẾ - KHU B — KCQ-B', pct:62, cls:'lo',  cranes:'10/10', amr:'22/22', tag:'tag-ok',  note:'✓ Ổn định' },
    { name:'KHO LẠNH PHÂN LOẠI — KLP', pct:55, cls:'lo',  cranes:'6/6',   amr:'14/16', tag:'tag-ok',  note:'✓ Còn dư công suất' },
  ],
  oee: [
    { id:'KNB-01', uptime:99.1, loi:'0.3/ngày', st:'ot', label:'QUÁ TẢI' },
    { id:'KCQ-A', uptime:96.8, loi:'1.2/ngày', st:'mt', label:'BẢO TRÌ' },
    { id:'KCQ-B', uptime:99.7, loi:'0.1/ngày', st:'ok', label:'TỐT' },
    { id:'KLP', uptime:99.5, loi:'0.2/ngày', st:'ok', label:'TỐT' },
  ],
  alerts: [
    { lvl:'crit', title:'KNB-01 — Kho Chuối Nhật Bản 01 đạt 96% công suất', desc:'Cần điều phối sang KCQ-A. Nguy cơ từ chối nhập hàng.', time:'08:42' },
    { lvl:'crit', title:'KCQ-A — PLC_07 mất kết nối', desc:'Stacker Crane #7 dừng hoạt động. Kỹ thuật đang xử lý.', time:'09:15' },
    { lvl:'warn', title:'KCQ-A — 2 AMR đang bảo trì định kỳ', desc:'AMR-14, AMR-19. Dự kiến hoàn thành 14:00.', time:'07:00' },
  ],
  trend: {
